...
import { PINGDM_BRAND, pingdmPageMetadata } from "@/lib/pingdmLegal";

export const metadata: Metadata = pingdmPageMetadata(
  "/pingdm/terms",
  "Terms of Service",
  "Terms for using the PingDM app and website."
);

export default function PingDMTermsPage() {
  return (
    <LegalPageShell title="Terms of Service" updated="August 24, 2026" brand={PINGDM_BRAND}>
      <section className="space-y-3">
        <h2>Agreement</h2>
        <p>
          By creating an account or using the PingDM mobile app or website, you agree to these Terms
          of Service. If you do not agree, do not use PingDM. <strong>PingDM</strong> is the product
          operated by <strong>Naman Technologies Private Limited</strong> (“PingDM,” “we,” “us”),
          registered in Nepal.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          businesses who use the PingDM app and website to list and sell products online through
          Instagram and Facebook. <strong>Buyers</strong> are people who purchase from sellers
          through the PingDM website and the PingDM app.
        </p>
      </section>
      ...
      <section className="space-y-3">
        <h2>Service</h2>
        <p>
          PingDM is a live shopping and social selling platform for merchants and creators. Sellers
          connect their own Instagram professional accounts and Facebook Pages inside PingDM so they
          can run selling, customer conversations, and content publishing from one place. Sellers use
          the PingDM app to go live or record shoppable video with product overlays, manage a catalog,
          and send buyers to a hosted checkout page. Viewers comment buy codes on Instagram or
          Facebook; PingDM may help the seller respond with order and product information (including
          checkout links) through Instagram or Messenger when connected and authorized. When the
          seller chooses to post from PingDM, we may publish product videos and Reels to that
          seller’s Instagram account and/or Facebook Page. PingDM also partners with logistics
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          Page and grant PingDM third-party access through Meta. By connecting, you authorize PingDM
        ...
        <ul>
          <li>
            ...
            show them in PingDM so you can respond to buyers quickly; when a buyer comments with a
            product buy code, help you send order and product information through Instagram or
            Messenger messages.
          </li>
          <li>
            <strong>Content publishing:</strong> When you choose to post from PingDM, publish product
        ...
        <p>
          ...
          features you requested. PingDM does not use Platform Data to build unrelated products, does
        ...
        <p>
          ...
          Policies. PingDM is not responsible for actions Meta takes on your account. You may revoke
          access at any time through Meta or PingDM settings; some features will stop working.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <ul>
          ...
          <li>You must honour orders placed through PingDM checkout unless legally entitled to refuse.</li>
          <li>You must not use PingDM for fraud, counterfeit goods, illegal items, or deceptive practices.</li>
      ...
      <section className="space-y-3">
        ...
        <p>
          PingDM processes buyer payments through third-party payment providers. PingDM charges a
      ...
      <section className="space-y-3">
        <h2>Logistics</h2>
        <p>
          PingDM partners with logistics providers to offer in-house logistics integration. When a
          seller books delivery through PingDM, buyer information required for shipping is shared
      ...
      <section className="space-y-3">
        ...
        <p>
          PingDM treats customer data with the utmost importance. Buyer personal data such as phone
        ...
        <p>
          ...
          operate, improve, secure, and enforce the PingDM service for the features you use —
          ...
          our{" "}
          <a href="/pingdm/privacy" className="font-medium text-violet-700 hover:underline">
            Privacy Policy
          </a>
      ...
      <section className="space-y-3">
        ...
        <ul>
          ...
          <li>Use PingDM to distribute malware, spam, or harmful content.</li>
          <li>Misrepresent your identity, products, or affiliation with PingDM or Meta.</li>
        </ul>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p>
          PingDM&apos;s software, branding, and documentation are owned by Naman Technologies Private
      ...
      <section className="space-y-3">
        <h2>Disclaimer</h2>
        <p>
          PingDM is provided &quot;as is&quot; and &quot;as available.&quot; We do not guarantee
      ...
      <section className="space-y-3">
        ...
        <p>
          To the fullest extent permitted by law, Naman Technologies Private Limited and PingDM are
          ...
          to the service is limited to the fees you paid to PingDM in the twelve (12) months before
      ...
      <section className="space-y-3">
        ...
        <p>
          ...
          required by law or Meta. You may stop using PingDM at any time. Sections that by nature
      ...
      <section className="space-y-3">
        <h2>Contact</h2>
        <p>
          PingDM is the product operated by <strong>Naman Technologies Private Limited</strong>,
          registered in Nepal.
        </p>
        <p>
