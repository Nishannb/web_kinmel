...
/** Legacy self-serve registration — kept for when PUBLIC_REGISTRATION_ENABLED is true. */
  ...
  return (
    <section className="mt-6 overflow-hidden rounded-3xl border border-fuchsia-100 bg-white/90 p-8 shadow-xl shadow-fuchsia-100/40">
      ...
      <p className="mt-2 text-sm leading-relaxed text-zinc-600">
        Use the same phone-based login pattern as the Kinmel mobile app. After registering, you can
        open the workspace and download the iOS app to go live.
      </p>
